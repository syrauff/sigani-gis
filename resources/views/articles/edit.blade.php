            ...
            <div class="bg-white p-6 shadow-md rounded-lg">
                <form action="{{ route('article.update', $article->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="title" id="title" class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring focus:ring-blue-500" value="{{ old('title', $article->title) }}" required>
                        @error('title') <p class="mt-2 text-sm text-red-600">{{ $message }}</p> @enderror
                    </div>

                    <div class="mb-4">
                        <label for="content" class="block text-gray-700 font-medium mb-2">Konten</label>
                        <textarea name="content" id="content" rows="5" class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring focus:ring-blue-500" required>{{ old('content', $article->content) }}</textarea>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="author" id="author" class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring focus:ring-blue-500" value="{{ old('author', $article->author) }}" required>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="category" id="category" class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring focus:ring-blue-500" value="{{ old('category', $article->category) }}" required>
                    ...
                    <div class="mb-4">
                        ...
                        @if ($article->image)
                            <div class="mb-2">
                                <img src="{{ asset('storage/' . $article->image) }}" alt="{{ $article->title }}" class="max-w-xs h-auto">
                                <p class="text-sm text-gray-600">Current image. Upload a new one to replace it.</p>
                            </div>
                        @endif
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="slug" id="slug" class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring focus:ring-blue-500" value="{{ old('slug', $article->slug) }}" required readonly>
